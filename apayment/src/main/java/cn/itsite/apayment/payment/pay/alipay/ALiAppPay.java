...
//                    onPayListener.onSuccess(PayType.ALiPay);
//                }
//            } else {
//                if (onPayListener != null) {
//                    onPayListener.onFailure(PayType.ALiPay, Integer.parseInt(result.get("resultStatus")));
//                }
//            }
...
//
//    @Override
//    public void pay(@NonNull final PayParams params, PaymentListener.OnPayListener onPayListener) {
//        this.onPayListener = onPayListener;
//        if (onPayListener != null) {
//            onPayListener.onStart(PayType.ALiPay);
//        }
//
//        Runnable payRun = new Runnable() {
//            @Override
//            public void run() {
//                PayTask task = new PayTask((Activity) params.getContext());
