...
public class CameraPlayActivity extends BaseMonitorActivity implements CameraSettingContract.View {
    ...
    public static String P2P_ACCEPT = "com.aglhz.yicommunity.P2P_ACCEPT";
    public static String P2P_READY = "com.aglhz.yicommunity.P2P_READY";
    public static String P2P_REJECT = "com.aglhz.yicommunity.P2P_REJECT";
