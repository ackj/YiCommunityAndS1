package com.itsite.yicommunity.main.smarthome.view;
...
import com.itsite.yicommunity.main.smarthome.presenter.SmartHomeMallPresenter;
...
public class SmartHomeMallFragment extends BaseFragment<SmartHomeMallContract.Presenter> implements SmartHomeMallContract.View {
    ...
    private void initListener() {
        ...
        goodsAdapter.setOnItemClickListener((adapter, view, position) -> {
            ...
            intent.putExtra(Constants.KEY_LINK, bean.getLink()+String.format("&token=%1$s&fromPoint=%2$s&appType=2",Params.token, com.itsite.s1.common.Constants.fromPoint));
