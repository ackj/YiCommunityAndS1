package com.itsite.yicommunity.main.home.model;
...
public class HomeModel extends BaseModel implements HomeContract.Model {
    ...
    public Observable<MainDeviceListBean> requestCommEquipmentList(Params params) {
        return HttpHelper.getService(com.itsite.s1.common.ApiService.class)
                .requestMainDeviceList(
                        com.itsite.s1.common.ApiService.requestMainDeviceList,
                        params.token,
