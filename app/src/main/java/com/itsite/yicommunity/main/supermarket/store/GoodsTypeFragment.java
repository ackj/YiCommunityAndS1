...
import com.itsite.yicommunity.main.supermarket.shopcart.ShopcartFragment;
...
/**
 * Author: LiuJia on 2017/11/1 0001 16:39.
...
//        mPresenter.start(params);
    ...
    private void initData() {
        GoodsTypeVPAdapter adapter = new GoodsTypeVPAdapter(getChildFragmentManager());
    ...
    public void onViewClicked() {
        _mActivity.start(ShopcartFragment.newInstance());
    }
}
